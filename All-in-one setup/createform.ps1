...
$delegatedFormCategories = @("Active Directory","Computer Management") #Only unique names are supported. Categories will be created if not exists
...
<# Begin: DataSource "AD-computer-generate-table-wildcard" #>
$tmpPsScript = @'
try {
...
AD-computer-generate-table-wildcard
'@ 
Invoke-HelloIDDatasource -DatasourceName $dataSourceGuid_0_Name -DatasourceType "4" -DatasourceInput $tmpInput -DatasourcePsScript $tmpPsScript -DatasourceModel $tmpModel -returnObject ([Ref]$dataSourceGuid_0) 
<# End: DataSource "AD-computer-generate-table-wildcard" #>
<# End: HelloID Data sources #>

<# Begin: Dynamic Form "AD Computer - Delete" #>
$tmpSchema = @"
[{"label":"Select group","fields":[{"key":"searchfield","templateOptions":{"label":"Search","placeholder":""},"type":"input","summaryVisibility":"Hide element","requiresTemplateOptions":true,"requiresKey":true},{"key":"gridComputers","templateOptions":{"label":"Select computer","required":true,"grid":{"columns":[{"headerName":"Name","field":"name"},{"headerName":"Description","field":"description"}],"height":300,"rowSelection":"single"},"dataSourceConfig":{"dataSourceGuid":"$dataSourceGuid_0","input":{"propertyInputs":[{"propertyName":"searchValue","otherFieldValue":{"otherFieldKey":"searchfield"}}]}},"useFilter":true},"type":"grid","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true}]}]
"@ 
...
AD Computer - Delete
'@
Invoke-HelloIDDelegatedForm -DelegatedFormName $delegatedFormName -DynamicFormGuid $dynamicFormGuid -AccessGroups $delegatedFormAccessGroupGuids -Categories $delegatedFormCategoryGuids -UseFaIcon "True" -FaIcon "fa fa-desktop" -returnObject ([Ref]$delegatedFormRef) 
<# End: Delegated Form #>
...
'@; 
	...
	$tmpVariables = @'
{"name":"name","value":"{{form.gridComputers.name}}","secret":false,"typeConstraint":"string"}
'@ 
